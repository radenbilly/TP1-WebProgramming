...
<html lang="en">
<head>
<title>Steering Buddy</title>
<link rel = "icon" href = "{{ asset('banner.jpg') }}" type = "image/x-icon">
<meta charset="UTF-8">
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i> Tangerang<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +6281392147981<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email: hello.steeringbuddy@gmail.com<br>
      </div>
      <div class="w3-col m6">
        <form action="#" target="#">
